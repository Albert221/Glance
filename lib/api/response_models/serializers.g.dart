...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(SubredditListData.serializer)
      ..add(SubredditListResponse.serializer)
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(SubredditResponse)]),
          () => new ListBuilder<SubredditResponse>()))
    .build();
